...
<html lang="en">
	...
	<body>
				...
				<div class="container-fluid">
			    	...
			    	<div id="navbar" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
			              	<li><a href="index.php?p=users.login"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Login</a></li>
			            </ul>
			  		</div>
				</div>
			</nav>
		...
		<footer class="footer">
      		<div class="container">
        		<p class="text-muted text-center">Luc Bettuzzi, Grégoire Harba , Marin0e Legros et Mathilde Prévost - <a href="mailto:roadtriphelper2@gmail.com">Contact</a>
